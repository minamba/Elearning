...
namespace ELearning.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        // GET: /Account/Login
        [AllowAnonymous]
        public ActionResult Login(string returnUrl, LoginRegisterLostViewModel m)
        {
        ...
        [AllowAnonymous]
        public ActionResult Register(string mess)
        {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var sm = new SendMail();
                    sm.SenEmail("webmaster.malik.ibn.anas@gmail.com","webmaster.malik.ibn.anas@gmail.com", "Création utilisateur", "Un nouveau membre(" + model.LastName +" "+ model.FirstName+") vient de s'inscrire. Pour que l'utilisateur puisse accéder à la plateforme, veuillez activer son compte.");
                ...
                return RedirectToAction("Register", new {mess = ViewBag.messageRegisterOk });
                }
                AddErrors(result);
            }
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                mail.SenEmail("webmaster.malik.ibn.anas@gmail.com", model.Email,"Réinitialiser le mot de passe", "Réinitialisez votre mot de passe en cliquant <a href=\"" + callbackUrl + "\">ici</a>");
                //return RedirectToAction("ForgotPasswordConfirmation", "Account");
            }

...
namespace ELearning.Controllers
{
    public class User_Controller : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if((bool)model.user_validate == true)
                        sm.SenEmail("webmaster.malik.ibn.anas@gmail.com", model.Email, "Bienvenue", "As salamou 3alaykoum wa rahmatulLah " + model.FirstName + ", votre compte à bien été crée et activé, vous pouvez des à present vous connecter sur la plateforme.");
                    else
                        sm.SenEmail("webmaster.malik.ibn.anas@gmail.com", model.Email, "Bienvenue", "As salamou 3alaykoum wa rahmatulLah " + model.FirstName + ", votre compte à bien été crée, vous recevrez un mail lors de l'activation de votre compte.");
        ...
        {
            User_ user_ = db.User_.Find(id);
            string asp_user_id = user_.user_asp_net_id;
            AspNetUsers asp_user = db.AspNetUsers.Find(asp_user_id);
            db.AspNetUsers.Remove(asp_user);
            ...
            if(CheckActive == true)
            {
                foreach( var u in users)
                {
                    if (u.type != 1)
                    {
                        ...
                        var sm = new SendMail();
                        sm.SenEmail("webmaster.malik.ibn.anas@gmail.com", u.mail, "Activation de votre Compte", "As salamou 3alaykoum wa rahmatulLah " + u.first_name + ", votre compte à été activé par un administrateur, vous pouvez des à present vous connecter sur la plateforme.");
